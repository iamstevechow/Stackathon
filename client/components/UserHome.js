...
class UserHome extends React.Component {
  ...
  turnOnSpeech() {
    ...
    recognition.onresult = event => {
      ...
      msg.lang = 'en-US';
      if (
        transcript.indexOf('add') !== -1 ||
        transcript.indexOf('adding') !== -1
      ) {
        ...
        transcript.indexOf('fridge') !== -1 ||
        transcript.indexOf('refrigerator') !== -1
      ) {
        ...
        transcript.indexOf('saved') !== -1 ||
        transcript.indexOf('my') !== -1
      ) {
        ...
        transcript.indexOf('recipe') !== -1 ||
        transcript.indexOf('recipes') !== -1
      ) {
